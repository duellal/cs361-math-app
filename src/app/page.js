...
export default function Home() {
    ...
    return (
        <div className="w-full mt-[32px] min-h-[calc(100dvh-246px)] flex flex-wrap place-content-center">
            ...
            <div className="flex flex-wrap px-[150px] place-content-center place-items-center justify-around">
                <h1 className="w-full text-white text-[42px] mb-[30px] text-center font-[600]">
                    Why MathPath?
                </h1>
