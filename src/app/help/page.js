        ...
        <div className="w-full mt-[32px]">
            <div className={`w-full place-items-center mb-[150px]`}>
                ...
                <ContentDiv
                    ...
                    div_tw={
                        'border-[12px] border-white bg-medium-blue w-[1000px] text-white p-[40px] rounded-[60px]'
                    }
            ...
            <div className={`w-full place-items-center`}>
                <h1 className="w-[900px] justify-center text-center text-[65px] font-bold mb-[50px]">
                    Have a Question?
                </h1>
                ...
                <ContentDiv
                    ...
                    div_tw={
                        'border-[12px] border-white bg-medium-blue w-[560px] px-8 rounded-[30px]'
                    }
