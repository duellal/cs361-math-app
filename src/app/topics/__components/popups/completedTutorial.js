...
export default function CompletedTutorial(props) {
    ...
    const completedTutorialH3 = (
        <h3 key={`completedTutorialAnswer-h3`} className={`m-0 ${h3Tw}`}>
            Congradulations!
        </h3>
    )

    const completedTutorialH4 = (
        <h4 key={`completedTutorialAnswer-h4`} className={h4Tw}>
